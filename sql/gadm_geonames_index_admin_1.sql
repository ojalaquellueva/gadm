...
-- 
-- geonames_state_province: Add country iso_aplpha3 column if 
-- not already exists
-- 
...
-- 
-- geonames_state_province: Change '.' to '-' in state_province_code2_full
...
-- 
-- geonames_state_province: Make FIPS codes same format as in admin1_crosswalk
-- column fips
-- 
...
-- 
-- geonames_state_province: Populate missing hasc codes by joining on crosswalk
-- 
...
-- Join directly to geonames_state_province
-- 
...
FROM admin1_crosswalk x JOIN geonames_state_province y
